function SendQuestion() {
  ...
  if (
    ...
    validar(mail, "mail-error") &&
    validar(edad, "edad-error") &&
    validar(tipo, "tipoMascota-error") && tipo > 0 &&
    validar(nom_mascota, "mascota-error") &&
    validar(consulta, "consulta-error") &&
    validarEmail(mail, "mail-error") &&
...
function limpiar_errores() {
  ...
  document.getElementById("tipoMascota-error").textContent = "";
...
function validar(valor, campo) {
  if (valor.trim() === "") {
    document.getElementById(campo).textContent =
      "Debe completar correctamente el campo.";
    return false;
  } else {
    document.getElementById(campo).textContent = "";
    return true;
